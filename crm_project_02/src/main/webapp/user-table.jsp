...
<body>
						...
						<div class="white-box">
							<div class="table-responsive">
								<table class="table" id="example">
									...
									<tbody>
										<c:forEach items="${listU}" var="item" varStatus="count">
											<tr>
												<td>${count.count}</td>
												<td>${item.firstName}</td>
												<td>${item.lastName}</td>
												<td>${item.userName}</td>
												<td>${item.id_role.name}</td>
												<td><a href="<c:url value='/user-update'/>?id=${item.id}" class="btn btn-sm btn-primary">Sửa</a>
													<a href='<c:url value='/user'/>' class="btn btn-sm btn-danger btn-xoa"
	...
	<script src="js/user-table.js" type="text/javascript"></script>
</body>
