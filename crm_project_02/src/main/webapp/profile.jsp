                    ...
                    <li>
                        <div class="dropdown">
                            <a class="profile-pic dropdown-toggle" data-toggle="dropdown" href="#">
                                <img src="https://yt3.googleusercontent.com/ytc/AOPolaSVPklW3XN57Q4LG2b8IdPh2FXsf1YMZzMuit1dYQ=s900-c-k-c0x00ffffff-no-rj" alt="user-img" width="36"
                                    class="img-circle" />
                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                    <c:forEach items="${listJob}" var="item" varStatus="count">
