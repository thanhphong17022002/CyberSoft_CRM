								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="email" class="form-control form-control-line"
											name="email" value="${user.email}" id="example-email">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-12">
										<select class="form-control form-control-line" name="role">
											<c:forEach items="${listR}" var="items">
												<option value="${items.id}"
													<c:if test="${items.id eq user.id_role.id}">selected="selected"</c:if>">${items.name}</option>
											</c:forEach>
										</select>
									</div>
								</div>
