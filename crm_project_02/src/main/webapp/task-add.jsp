						...
						<div class="white-box">
							<form action="<c:url value='/task-add'/>" method="POST"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<select class="form-control form-control-line" name="id_user">
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										...
										<c:if test="${not empty errStartD}">
											<span style="color: red">${errStartD}</span>
										</c:if>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="date" name="endDate" placeholder="dd/MM/yyyy"
											class="form-control form-control-line">
										<c:if test="${not empty errEndD}">
											<span style="color: red">${errEndD}</span>
										</c:if>
									</div>
								</div>
								<div class="form-group">
							...
							<c:if test="${not empty dup}">
								<span style="color: red">${dup}</span>
							</c:if>

							<c:choose>
								<c:when test="${not empty isSuccess && isSuccess}">
									<span style="color: green">Add successful</span>
								</c:when>
								<c:when test="${not empty isSuccess && !isSuccess}">
									<span style="color: red">Add fail</span>
								</c:when>
							</c:choose>
						</div>
					</div>
